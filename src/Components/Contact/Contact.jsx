		...
		>
			<div className={styles.container}>
				...
				>
					...
					{/* <a
						href='mailto: khanfaizan2505@gmail.com'
						aria-label='email'
						target='_blank'
						rel='noreferrer'
					>
					...
					<a
						href='https://github.com/faizanfzk'
						aria-label='GitHub'
						rel='noreferrer'
						target='_blank'
					>
					...
					<a
						href='https://www.linkedin.com/in/faizan-khan7/'
						aria-label='Linkedin'
						target='_blank'
						rel='noreferrer'
					>
			...
			>
				Designed and build by Faizan Khan, 2022 All rights
				reserved.
			</div>
		</footer>
	);
